...
const bedrockPlugins = {
  ...
  inventory: require('./bedrockPlugins/inventory.mts').default, // possible to implement everything | includes a few item transactions | armor and off-hand not supported rn | req pitem support | req pwindow support or bedrock features
  ...
  simple_inventory: require('./bedrockPlugins/simple_inventory.mts').default, // armor and off-hand not supported
